...
class _SplashPageState extends State<SplashPage> with TickerProviderStateMixin {
  ...
  void _initHorizontalAnimation() {
    _horizontalController =
        AnimationController(
          ...
          if (status == AnimationStatus.completed ||
            ...
            _horizontalController.duration = Duration(
    ...
    _setRandomSlideTween();
    _horizontalShake = Tween<double>(begin: -5, end: 5).animate(
      CurvedAnimation(
  ...
  void _scheduleNextVerticalShake() {
    ...
    _verticalTimer = Timer(nextDelay, () async {
      ...
      _verticalShake =
          Tween<double>(
            begin: 0,
            end: amplitude * (_random.nextBool() ? 1 : -1),
          ).animate(
            CurvedAnimation(
      ...
      _verticalController.duration = Duration(
        milliseconds: 600 + _random.nextInt(400),
      );
        ...
        Stack(
          ...
          children: [
            Icon(
              ...
              color: Colors.black45.withAlpha((0.2 * 255).toInt()),
              size: 56,
            ),
  ...
  Widget _builTitleTranslation(Widget? child) {
    return Transform.translate(
      offset: Offset(
        _slide.value + _horizontalShake.value,
        _verticalShake.value,
      ),
      child: child,
    );
  }
