abstract class PostInfoMock {
  ...
  static List<Map<String, dynamic>> get allPostInfoJson => [
    ...
    },
    {
      ...
      'tags': ['미래 도시의 비전', '지속가능', '인간 중심적인 도시 설계'],
    },
    {
      'postId': '109',
      'userId': '91',
